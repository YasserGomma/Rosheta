...
public class AllMedicinesAdapter extends RecyclerView.Adapter<AllMedicinesAdapter.MedicinesItemViewHolder> {
    public static String medicineID_Adapter = "";
    ArrayList<AllMedicines> medicines = new ArrayList<>();
    Context context;

    public AllMedicinesAdapter(Context context, ArrayList<AllMedicines> medicines) {
    ...
    public void onBindViewHolder(MedicinesItemViewHolder holder, int position) {
        ...
        AllMedicines item = medicines.get(position);

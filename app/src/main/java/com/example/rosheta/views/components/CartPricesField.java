package com.example.rosheta.views.components;
...
import com.example.rosheta.helpers.SizeUtilities;
...
public class CartPricesField extends RelativeLayout {
    ...
    public CartPricesField(Context context, @Nullable AttributeSet attrs) {
        ...
        setLayoutParams(new LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.MATCH_PARENT));
        buildComponent();
    }
    ...
    void buildComponent() {
        ...
        LayoutParams params2 = new LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        ...
        LayoutParams params3 = new LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        ...
        LayoutParams params4 = new LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        ...
        LayoutParams params5 = new LayoutParams(LayoutParams.MATCH_PARENT, SizeUtilities.Dp2Px(context, 1));

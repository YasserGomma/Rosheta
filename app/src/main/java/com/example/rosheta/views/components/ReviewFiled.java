...
import com.example.rosheta.views.widgets.IllustrativeText;
...
public class ReviewFiled extends LinearLayout {
    ...
    void buildComponent() {
        ...
        LayoutParams params1 = new LayoutParams(SizeUtilities.Dp2Px(context, 13), SizeUtilities.Dp2Px(context, 13));
        ...
        LayoutParams params2 = new LayoutParams(SizeUtilities.Dp2Px(context, 70), SizeUtilities.Dp2Px(context, 1));
